...
- Requirements for the fingerprint function $f$:
  ...
  - Given set ${c_1, c_2, c_3}$ the fingerprint is $f(f(f("initial", c_1), c_2), c_3)$
  - Order-invariant: $f(f(f("initial", c_1), c_2), c_3) = f(f(f(emptyset, c_3), c_2), c_1)$
...
#slide[
  ...
  *Future Work*
  ...
  #v(0.8em)
  #align(center)[
    #set text(size: 18pt, fill: accent-color)
    Questions? \
    #set text(size: 16pt, fill: luma(120))
